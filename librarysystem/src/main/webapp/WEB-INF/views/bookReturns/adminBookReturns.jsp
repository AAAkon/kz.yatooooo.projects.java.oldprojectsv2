                            ...
                            <tr class='${bgClass}'>
                                ...
                                <td>
	                                <c:if test="${bookReturn.getStatus() == bookReturn.getStatusCodePending()}">
	                                	<span class="countdown text-danger">${bookReturn.getLeftDate()}</span>
                                ...
                                <td class="nowrap">
                                	<a href="seeBookReturn?id=${bookReturn.getId()}&redirectUrl=adminBookReturns" class='btn btn-warning btn-xs'>
	                                	<i class="fa fa-eye"> </i>
	                                	See
	                                </a>
	                                <c:if test="${bookReturn.getStatus() == bookReturn.getStatusCodePending()}">
	                                   	<a href="seeBookReturn?id=${bookReturn.getId()}&redirectUrl=adminBookReturns" class='btn btn-success btn-xs'>
		                                	<i class="fa fa-check"> </i>
		                                	Accept
		                                </a>
		                                <a href="seeBookReturn?id=${bookReturn.getId()}&redirectUrl=adminBookReturns" class='btn btn-danger btn-xs'>
		                                	<i class="fa fa-ban"> </i>
		                                	Penalty
		                                </a>
	                                </c:if>
